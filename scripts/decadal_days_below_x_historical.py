...
var = 'min_temp'
# SILO in Eratos is in celsius
threshold_temp_celsius = 0
...
for date_val in date_range:
        ...
        bool_arr = extracted_data[count:count+year_delta.days] <= (threshold_temp_celsius)
...
hist_decades= ['1980s','1990s','2000s','2010s']

#Historical collating
historical_decades= ['1980','1990','2000','2010','2020']


for idx , decade in enumerate(hist_decades):
    
    decade_year_list = pd.date_range(historical_decades[idx], historical_decades[idx+1], freq="Y")
...
geo_dataframe.to_file('data/1980_to_2020_decadal_days_below_0.geojson', driver='GeoJSON')